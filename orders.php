...
<html lang="en" dir="ltr">
	<head>
		...
		<title>KD DEALERSHIP | product</title>
	</head>
	<body>
		<div class="order-all">
			<div class="heading">
				<h1><a href="javascript:history.back();"><i class="fas fa-angle-double-left"></i></a>KD DEALERSHIP <span> Admin </span> </h1>
			</div>
			<div class="user-info">
		...
		<footer>
		  ...
		  <div class="credit">
		  	<h1>KD DEALERSHIP | Developed by KD Team</h1>
		  </div>
		</footer>
	</body>
</html>
